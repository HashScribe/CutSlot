    ...
    <Card className="bg-gradient-to-br from-card to-secondary/40">
      <CardContent className="grid gap-5 p-5 md:grid-cols-[1.4fr_1fr] md:items-center">
        ...
        <div className="rounded-lg border border-border bg-background/50 p-4">
          ...
          <p className="mt-3 text-sm font-medium">Next setup step</p>
          <p className="mt-1 text-sm text-muted-foreground">Connect Supabase Auth and resolve the active tenant from membership.</p>
        </div>
      </CardContent>
    </Card>
  );
